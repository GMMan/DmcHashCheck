    ...
    internal static class HashChecker
    {
        ...
        public static readonly IReadOnlyList<FirmwareInfo> FIRMWARES = new List<FirmwareInfo>()
        {
            ...
            new FirmwareInfo
            {
                ...
                IdentifierFunction = (br) =>
                {
                    br.BaseStream.Seek(0x6392, SeekOrigin.Begin);
                    return br.ReadUInt16() == 0x490c && br.ReadUInt16() == 0x015f;
                },
                Regions =
                [
                    new CheckRegion
                    {
                        StartOffset = 0,
                        EndOffset = 0x3fffff,
                        Hash = [0xef, 0x37, 0x11, 0xc1, 0x6d, 0x21, 0xfe, 0x90, 0xda, 0x3e, 0x7d, 0xab, 0x22, 0x1a, 0x75, 0x20, 0xb1, 0x33, 0x79, 0x36, 0x20, 0x8d, 0x7e, 0xe3, 0xd2, 0xe9, 0x0f, 0x5a, 0x03, 0x41, 0x00, 0xdc]
                    },
                    new CheckRegion
                    {
                        StartOffset = 0x400000,
                        EndOffset = 0x7fcfff,
                        Hash = [0xbc, 0x8a, 0xc1, 0xb4, 0x61, 0xc7, 0x33, 0x4c, 0xa6, 0xee, 0xd0, 0x89, 0xfe, 0x89, 0x4e, 0xbc, 0xaa, 0x16, 0xcf, 0x80, 0xbd, 0xae, 0xb9, 0x5f, 0x9d, 0x17, 0xac, 0x1d, 0xc0, 0xe8, 0x61, 0x23]
                    },
                    new CheckRegion
                    {
                        StartOffset = 0x7ff000,
                        EndOffset = 0x7fffff,
                        Hash = [0x2a, 0x8b, 0x6c, 0x34, 0x05, 0x87, 0x97, 0xe6, 0x39, 0x33, 0x5b, 0x52, 0xde, 0x97, 0xdd, 0x39, 0xea, 0x61, 0xc0, 0x10, 0x20, 0xc6, 0x2a, 0x6e, 0x71, 0x8a, 0xfd, 0x1d, 0x16, 0x4a, 0x61, 0xd8]
                    }
                ]
            },
            new FirmwareInfo
            {
                ...
                IdentifierFunction = (br) =>
                {
                    br.BaseStream.Seek(0x18928, SeekOrigin.Begin);
                    return br.ReadUInt16() == 0x9646 && br.ReadUInt16() == 0xfe00 && br.ReadUInt16() == 0x990c && br.ReadUInt16() == 0x0d08 && br.ReadUInt16() == 0xd6e4;
                },
                Regions = new[]
                {
                    new CheckRegion
                    {
                        StartOffset = 0,
                        EndOffset = 0x3fffff,
                        Hash = new byte[] { 0xfc, 0xeb, 0x5d, 0x1c, 0x86, 0xb9, 0xe1, 0x63, 0xfc, 0x6d, 0xdd, 0x81, 0xed, 0x3c, 0x8e, 0x50, 0xdc, 0x39, 0x7f, 0xa7, 0x7c, 0xac, 0x94, 0x3f, 0x77, 0x9b, 0xfb, 0x9a, 0xd3, 0x52, 0xba, 0x9d }
                    },
                    new CheckRegion
                    {
                        StartOffset = 0x400000,
                        EndOffset = 0x7fcfff,
                        Hash = new byte[] { 0xaa, 0x48, 0x0c, 0xda, 0x93, 0x42, 0xb5, 0x62, 0xc2, 0x03, 0x0c, 0xed, 0xf0, 0xe3, 0xda, 0x08, 0xed, 0x92, 0x39, 0x72, 0x9a, 0x28, 0x1e, 0x3c, 0x2e, 0x5d, 0xe2, 0xa0, 0x74, 0x21, 0xee, 0x4b }
                    },
                    new CheckRegion
                    {
                        StartOffset = 0x7ff000,
                        EndOffset = 0x7fffff,
                        Hash = new byte[] { 0xbf, 0xc2, 0x0d, 0x17, 0x4a, 0xa3, 0xb0, 0xec, 0xeb, 0x49, 0xf7, 0xf8, 0xad, 0x81, 0xf6, 0x1f, 0x7e, 0xcf, 0xeb, 0x38, 0x0c, 0x6d, 0x46, 0x17, 0x64, 0xce, 0x7e, 0xf6, 0x01, 0xcb, 0x63, 0x37 }
                    }
                }
            },
            new FirmwareInfo
            {
                ...
                IdentifierFunction = (br) =>
                {
                    br.BaseStream.Seek(0x18898, SeekOrigin.Begin);
                    return br.ReadUInt16() == 0x9647 && br.ReadUInt16() == 0xfe00 && br.ReadUInt16() == 0x990c && br.ReadUInt16() == 0x0d08 && br.ReadUInt16() == 0xd6e4;
                },
                Regions = new[]
                {
                    new CheckRegion
                    {
                        StartOffset = 0,
                        EndOffset = 0x3fffff,
                        Hash = new byte[] { 0xd9, 0x19, 0xc8, 0x77, 0xf7, 0x42, 0xb3, 0xfe, 0x75, 0x2d, 0x8e, 0x70, 0x64, 0xf1, 0x6b, 0x6b, 0x51, 0x92, 0x85, 0xf9, 0xc6, 0x07, 0x00, 0x43, 0x3a, 0x77, 0x26, 0x2d, 0x24, 0x09, 0x58, 0x64 }
                    },
                    new CheckRegion
                    {
                        StartOffset = 0x400000,
                        EndOffset = 0x7fcfff,
                        Hash = new byte[] { 0x50, 0x5d, 0x97, 0xda, 0x2a, 0xee, 0x3d, 0x81, 0x50, 0xee, 0x3a, 0x9f, 0xd9, 0x3e, 0x2a, 0x29, 0x51, 0x46, 0x14, 0x51, 0x32, 0xf8, 0xd9, 0x0b, 0x6e, 0x92, 0x6d, 0xe0, 0xa3, 0x83, 0x3a, 0x3b }
                    },
                    new CheckRegion
                    {
                        StartOffset = 0x7ff000,
                        EndOffset = 0x7fffff,
                        Hash = new byte[] { 0x23, 0x96, 0xc9, 0xf2, 0xa6, 0x58, 0xb7, 0xa5, 0x8e, 0xa1, 0x30, 0x96, 0xe9, 0x40, 0xf5, 0xdb, 0xc6, 0xf1, 0x3c, 0xc3, 0x63, 0xac, 0xca, 0x0f, 0x18, 0x12, 0x89, 0x14, 0x33, 0xe1, 0xcd, 0x99 }
                    }
                }
            },
            new FirmwareInfo
            {
                ...
                IdentifierFunction = (br) =>
                {
                    ...
                    return br.ReadUInt16() == 0x970b && br.ReadUInt16() == 0x5758;
                },
                Regions = new[]
                {
                    new CheckRegion
                    {
                        StartOffset = 0,
                        EndOffset = 0x7ffff,
                        Hash = new byte[] { 0xae, 0x76, 0xb4, 0x9c, 0x66, 0x2d, 0x56, 0x77, 0xee, 0x33, 0x20, 0x3a, 0x5b, 0xfd, 0x4f, 0xdb, 0x87, 0x9f, 0xae, 0xab, 0x7a, 0x6c, 0xa1, 0x99, 0x7f, 0x9b, 0xf4, 0x34, 0x7c, 0xf1, 0x51, 0x12 }
                    },
                    new CheckRegion
                    {
                        StartOffset = 0x80000,
                        EndOffset = 0x7fcfff,
                        Hash = new byte[] { 0x67, 0x08, 0x1d, 0x9e, 0x2a, 0x0c, 0x61, 0x98, 0x8e, 0x82, 0x50, 0x7e, 0x14, 0xc4, 0xa0, 0x6d, 0x56, 0x09, 0x99, 0x81, 0x5a, 0x9e, 0xdd, 0x75, 0x1d, 0x4c, 0xbc, 0x38, 0x12, 0x9a, 0xd2, 0xdf }
                    },
                    new CheckRegion
                    {
                        StartOffset = 0x7ff000,
                        EndOffset = 0x7fffff,
                        Hash = new byte[] { 0x34, 0x38, 0xdf, 0xb7, 0x41, 0xe5, 0x6d, 0xf3, 0x60, 0x92, 0x1a, 0x50, 0xcc, 0xec, 0x91, 0xd4, 0x7a, 0x61, 0x3a, 0x87, 0x22, 0x1e, 0x18, 0xa7, 0x37, 0xa7, 0xf5, 0x2e, 0xe0, 0xbc, 0x29, 0xa4 }
                    }
                }
            },
        }.ToImmutableList();
